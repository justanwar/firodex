/// NB! The following code is copied from the gap package verbatim to avoid
/// the unnecessary overhead on the OPSEC team.
///
/// The original package also has a gap widget for slivers, but it is not
/// included here.
///
/// Credit: https://github.com/letsar/gap/blob/master/lib/src/rendering/gap.dart
///
/// ============================================================================
