...
class RampPurchaseWatcher {
  ...
  Stream<FiatOrderStatus> watchOrderStatus({
    ...
    scheduleMicrotask(() async {
      ...
      final stream = watchNewRampOrdersCreated().takeWhile((purchase) =>
          !controller.isClosed &&
          (purchaseDetails == null || !watchFirstPurchaseOnly));
      try {
        subscription = stream.listen(
          (newPurchaseJson) => purchaseDetails =
              RampPurchaseDetails.tryFromMessage(newPurchaseJson),
          cancelOnError: false,
        );
  ...
  static Future<FiatOrderStatus> _getPurchaseStatus(
      RampPurchaseDetails purchase) async {
  ...
  static RampPurchaseDetails? tryFromMessage(Map<String, dynamic> message) {
    ...
    try {
      ...
      final Map<String, dynamic> purchase =
          Map<String, dynamic>.from(payload['purchase'] as Map);
