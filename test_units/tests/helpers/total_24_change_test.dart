...
void testGetTotal24Change() {
  test('getTotal24Change calculates total change', () {
    ...
    double? result2 = getTotal24Change(coins);
  ...
  test('getTotal24Change calculates total change', () {
    ...
    double? result2 = getTotal24Change(coins2);
  ...
  test('getTotal24Change returns null for empty or null input', () {
    double? resultEmpty = getTotal24Change([]);
    double? resultNull = getTotal24Change(null);
    ...
    double? resultZeroBalance = getTotal24Change(coins);
    ...
    double? resultNoChangeFor24h = getTotal24Change(coins2);
